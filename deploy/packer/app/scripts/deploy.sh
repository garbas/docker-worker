...
docker pull garbas/relengapi-proxy:ami-test
...
docker save taskcluster/taskcluster-proxy:4.0.1 taskcluster/livelog:v4 taskcluster/dind-service:v4.0 garbas/relengapi-proxy:ami-test > /home/ubuntu/docker_worker/docker_worker_images.tar
